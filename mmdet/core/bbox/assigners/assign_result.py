...
class AssignResult(object):
    ...
    def info(self):
        ...
        if __debug__:
            if self.labels is not None:
                assert torch.all(self.labels[self.gt_inds == 0] == 0)
                assert torch.all(self.labels[self.gt_inds > 0] > 0)
        return {
    ...
    def random(cls, **kwargs):
        ...
        Example:
            ...
            >>> self = AssignResult.random(num_gts=0, num_preds=0)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))

            >>> self = AssignResult.random(num_gts=0, num_preds=3)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))

            >>> self = AssignResult.random(num_gts=3, num_preds=3)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))

            >>> self = AssignResult.random(num_gts=0, num_preds=3)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))

            >>> self = AssignResult.random(num_gts=7, num_preds=7)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))

            >>> self = AssignResult.random(num_gts=7, num_preds=64)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))

            >>> self = AssignResult.random(num_gts=24, num_preds=3)
            >>> print('{}'.format(ub.repr2(self.info, nl=1)))
